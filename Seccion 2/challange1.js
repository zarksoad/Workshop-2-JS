...
let continuar = true;
while (continuar) {
  nivel_de_energia = parseInt(
    prompt('Del 1 al 100 cual es tu nivel de energia')
  );
  clima = confirm(
    'ingresa aceptar para un buen clima o cancelar para un mal clima'
  );
  carga_de_trabajo = parseInt(
    prompt('Ingresa tu carga de trabajo del 1 al 100')
  );
  if (!isNaN(nivel_de_energia) && !isNaN(carga_de_trabajo)) {
